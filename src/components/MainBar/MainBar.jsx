...
const MainBar = () => {
    ...
    return (
        <div className="">
           ...
           {/* responsive start */}
           <div className={`h-[2300px] lg:h-[100%]  px-[15px] pt-[12px] mainBar-container mt-[12px] ml-[14.76px] mr-[16px] block md:hidden absolute z-[5] duration-500 ease-in-out ${open ? 'left-[-15px] top-[-10px]' : 'left-[-500px] top-[-10px]'}`}>
